      ...
      <div className="flex items-start gap-4">
        ...
        <button
          ...
          className={`
            ...
            flex-shrink-0
            mt-1
            ${isDone ? "bg-pop-gold" : "bg-cloud-cream hover:bg-sky-light"}
          `}
          aria-label={isDone ? "Mark as pending" : "Mark as done"}
        >
          {isDone && <Check size={16} className="text-ink" strokeWidth={4} />}
        </button>

        {/* Content */}
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3 mb-2 flex-wrap">
            <div className="flex items-center gap-2 text-pop-gold font-terminal text-lg">
          ...
          <p
            className={`
              font-terminal text-xl text-ink
              ${isDone ? "line-through text-ink-dim" : ""}
            `}
          >
            {item.activity}
          </p>
